...
public class Prototype : MonoBehaviour {
    ...
    public event Action OnReturnFromPool;
    Prototype _originalPrototype;
    Prototype[] _pool = new Prototype[10];

    [SerializeField]List<Prototype> _instancePool = new List<Prototype>();
	...
	public T Instantiate<T>()  where T : Component
	{
        ...
        if (instance.OnReturnFromPool != null)
	...
	void AddToPool(Prototype instancePrototype)
	{
		...
		_instancePool.Add(instancePrototype.gameObject.GetComponent<Prototype>());
